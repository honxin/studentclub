...
<body >
	...
	<form action="{{ action('Admin\ActivityController@update',$act->id) }}" method="post" >
    		...
    		<table class="ui basic table">
			  <tbody>
			      ...
			      <td>
						  ...
						  <input type="hidden" name="assoc_id" value="{{$act->assocs[0]->id}}">
			    	...
			    	<td>
			    		<div class="field">
					     <div class="ui left labeled icon input" >
					      <input type="text" name="title" value="{{$act->title}}" placeholder="活动名称" />
					     </div>
					    </div>
			    	</td>
			    </tr>
			    ...
			    <tr>
			    	...
			    	<td>
			    		<div class="field">
					     <div class="ui left labeled icon input" >
					      开始<input type="text" name="start_time" value="{{$act->start_time}}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"> 
					      结束<input type="text" name="end_time" value="{{$act->end_time}}" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"> 
					     </div>
					    </div>
			    	</td>
			    </tr>  
			    ...
			    <tr>
			    	...
			    	<td>
			    		<div class="field">
					     <div class="ui left labeled icon input" >
					      <input type="text" name="place" value="{{$act->place}}" placeholder="活动地点" />
					     </div>
					    </div>
			    	</td>
			    </tr>
			    ...
			    <tr>
			    	...
			    	<td>
			    		<div class="field">
						    <textarea name="description" placeholder="活动简介">{{$act->description}}</textarea>
						</div>
			    	</td>
			    </tr>
			    ...
			    <tr>
                    <td colspan="2">
                        <textarea name='content' id='content'>{{$act->content}}</textarea>
                    </td>
                </tr>
